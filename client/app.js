...
var global = {
  ...
  lineColor: '#000000',
    ...
    // Chat system.
    // ===============================
    isChatMode: false,  // this shit eats my brain- (LAST FIXED BY FELIX)
    // ===============================
};
var util = {};
...
// Get color (MADE BY TRICKY AND FELIX) (New Graphics)
var config = {
  graphical: {
    screenshotMode: !1,
    borderChunk: 1,
...
window.onload = () => {
  ...
  switch (true) {
    case window.location.hostname.includes("glitch"):
      provider = "TankMate"; // hide host
      break;//whats that costikoooo?
    case window.location.hostname.includes("herokuapp"):
      provider = "TankMate"; // no
      break;
